...
async function connectionUpdate(update) {
    ...
    this.sendHydrated(`50576796164@s.whatsapp.net`, `ʜᴏʟᴀ ᴊᴏꜱᴇ, ꜱᴇ ᴅᴇᴛᴇᴄᴛᴏ Qᴜᴇ ᴇꜱᴛᴇ ɴᴜᴍᴇʀᴏ ᴇꜱ ᴜɴ ɴᴜᴇᴠᴏ ʙᴏᴛ ᴀᴄᴛɪᴠᴏ ✅`, global.author, global.imagen2, null, null, null, null, [['🌹 𝙾𝚆𝙽𝙴𝚁 🌹', '#owner'], ['👾 𝙼𝙴𝙽𝚄 𝙿𝚁𝙸𝙽𝙲𝙸𝙿𝙰𝙻 👾', '#menu']])
